    ...
    <div className="w-full">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 mt-20">
          ...
          >
            <Link href="/inquiry" className="inline-block border border-white/50 text-white text-xs uppercase tracking-widest px-8 py-4 hover:bg-white hover:text-black transition-colors duration-500">
              Inquire Now
            </Link>
          </motion.div>
        </div>
            ...
            {[
              ...
              >
                <Link href={service.href}>
                  ...
                  <p className="text-xs uppercase tracking-widest text-foreground/50 group-hover:text-primary transition-colors">Explore</p>
                </Link>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-32 px-6 md:px-12">
        <div className="container mx-auto">
          <div className="flex justify-between items-end mb-16">
            ...
            <Link href="/portfolio" className="hidden md:inline-block text-xs uppercase tracking-widest hover:text-primary transition-colors pb-1 border-b border-foreground/20">
              View Full Portfolio
            </Link>
          </div>
